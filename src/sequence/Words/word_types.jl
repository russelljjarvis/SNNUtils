...
function make_word_type_dict(allwords)
  ...
  :animate  => collect_words_of_type( allwords, Word("",[],["noun"],["animate"],[]) ),
  :human    => collect_words_of_type( allwords, Word("",[],["noun"],["human"],[]) ),
  :agent    => collect_words_of_type( allwords, Word("",[],["noun"],[],["agent"]) ),
  ...
  :drinkable=> collect_words_of_type( allwords, Word("",[],["noun"],[],["drinkable"]) ),
  :chasable => collect_words_of_type( allwords, Word("",[],["noun"],[],["chasable"]) ),
  :pettable => collect_words_of_type( allwords, Word("",[],["noun"],[],["pettable"]) ),
  :kickable => collect_words_of_type( allwords, Word("",[],["noun"],[],["kickable"]) ),
  :edible   => collect_words_of_type( allwords, Word("",[],["noun"],[],["edible"]) ),
  )
end
